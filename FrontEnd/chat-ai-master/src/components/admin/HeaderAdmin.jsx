...
export default function HeaderAdmin({ onToggleSidebar }) {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white dark:bg-gray-900 border-b dark:border-gray-700 shadow-sm">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <div className="relative" ref={menuRef}>
            <img
              ...
              alt="avatar"
              className="w-8 h-8 rounded-full cursor-pointer select-none border-2 border-gray-300 dark:border-gray-600"
              onClick={() => setOpenMenu((prev) => !prev)}
            />

            {/* Dropdown menu */}
            {openMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-1 text-sm text-gray-700 dark:text-gray-200 z-50">
                ...
                {/* Modal nằm riêng, không bọc trong button */}
                <ProfileModal
                  open={openProfile}
